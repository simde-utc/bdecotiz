    ...
    <div class="container">
      ...
      <?php if($loggedin): ?>
        ...
        <?php if($userInfo->is_cotisant): ?>
            ...
            <p>Pour bénéficier des <a href="http://assos.utc.fr/partenaires" target="_blank">avantages BDE-UTC</a>, n'oublie pas de venir faire mettre la pastille BDE, sur ta carte étudiante.<br />Le BDE est actuellement en G101.</p>
        <?php else: ?>

    ...
    <div class="container">
      ...
      <?php if($loggedin): ?>
        ...
        <?php if($userInfo->is_cotisant): ?>
            <p>Félicitations tu as bien <strong>cotisé</strong> !</p>
            <p>Pour bénéficier des <a href="http://assos.utc.fr/partenaires" target="_blank">avantages BDE-UTC</a>, n'oublie pas de venir faire mettre la pastille BDE, sur ta carte étudiante.<br />Le BDE est actuellement en E101.</p>
        <?php else: ?>
            <p>Tu n'as pas encore cotisé...</p>
      ...
      <?php else: ?>
        ...
        Connecte toi pour regarder si tu as déjà cotisé !</p>
